...
theme.set_highlights = function(opts)
    ...
    hl("CursorLine", { bg = c.vscCursorDarkDark })
    ...
    hl("EndOfBuffer", { fg = c.vscBack, bg = c.vscNone })
    ...
    hl("IncSearch", { fg = c.vscNone, bg = c.vscSearchCurrent })
    hl("LineNr", { fg = c.vscLineNumber, bg = c.vscBack })
    hl("CursorLineNr", { fg = c.vscPopupFront, bg = c.vscBack })
    ...
    hl("NonText", { fg = c.vscLineNumber, bg = c.vscNone })
    hl("Pmenu", { fg = c.vscPopupFront, bg = c.vscPopupBack })
    hl("PmenuSel", { fg = c.vscPopupFront, bg = c.vscPopupHighlightBlue })
    hl("PmenuSbar", { fg = c.vscNone, bg = c.vscPopupHighlightGray })
    ...
    hl("StatusLine", { fg = c.vscFront, bg = c.vscLeftMid })
    ...
    hl("Todo", { fg = c.vscYellowOrange, bg = c.vscBack, bold = true })
    ...
    hl("Whitespace", { fg = c.vscLineNumber })
    ...
    hl("TSKeyword", { fg = c.vscPink, bg = c.vscNone })
    hl("TSKeywordFunction", { fg = c.vscBlue, bg = c.vscNone })
    ...
    hl("TSNote", { fg = c.vscBlueGreen, bg = c.vscNone, bold = true })
    hl("TSWarning", { fg = c.vscYellowOrange, bg = c.vscNone, bold = true })
    ...
    hl("goTodo", { fg = c.vscGreen, bg = c.vscNone })
    ...
    hl("pythonTodo", { fg = c.vscBlue, bg = c.vscNone })
    ...
    -- NvimTree
    hl("NvimTreeCursorLine", { fg = c.vscNone, bg = opts.disable_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftMid })
    hl("NvimTreeEmptyFolderName", { fg = c.vscGray, bg = c.vscNone })
    hl("NvimTreeEndOfBuffer", { fg = opts.disable_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftDark })
    ...
    hl("NvimTreeNormal", { fg = c.vscFront, bg = opts.disable_nvimtree_bg and c.vscBack or c.vscLeftDark })
    hl("NvimTreeOpenedFolderName", { fg = c.vscNone, bg = opts.disable_nvimtree_bg and c.vscCursorDarkDark or c.vscLeftDark })
    ...
    hl("NvimTreeVertSplit", { fg = opts.disable_nvimtree_bg and c.vscSplitDark or c.vscBack, bg = c.vscBack })
    ...
    hl("DiagnosticWarn", { fg = c.vscYellow, bg = c.vscNone })
    hl("DiagnosticInfo", { fg = c.vscBlue, bg = c.vscNone })
    hl("DiagnosticHint", { fg = c.vscBlue, bg = c.vscNone })
    hl("DiagnosticUnderlineError", { fg = c.vscNone, bg = "NONE", undercurl = true, sp = c.vscRed })
    hl("DiagnosticUnderlineWarn", { fg = c.vscNone, bg = "NONE", undercurl = true, sp = c.vscYellow })
    hl("DiagnosticUnderlineInfo", { fg = c.vscNone, bg = "NONE", undercurl = true, sp = c.vscBlue })
    hl("DiagnosticUnderlineHint", { fg = c.vscNone, bg = "NONE", undercurl = true, sp = c.vscBlue })
    ...
    hl("LspReferenceRead", { fg = c.vscNone, bg = c.vscPopupHighlightGray })
    hl("LspReferenceText", { fg = c.vscNone, bg = c.vscPopupHighlightGray })
    hl("LspReferenceWrite", { fg = c.vscNone, bg = c.vscPopupHighlightGray })
